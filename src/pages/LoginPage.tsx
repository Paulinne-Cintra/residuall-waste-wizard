        ...
        <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-residuall-gray-dark">
                    Lembre-se
                  </label>
                </div>
                
                <div className="text-sm">
                  <a href="#" className="text-residuall-green hover:text-residuall-green-light">
                    Esqueceu a senha?
                  </a>
                </div>
              </div>
            ...
            <div className="text-center mt-6">
              ...
              <Link to="/cadastro" className="text-residuall-green hover:text-residuall-green-light font-medium">
                Cadastrar-se
              </Link>
            </div>
          </div>
